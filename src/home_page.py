...
def _condition_palette(
    ...
    """
    ClimatePulse Home hero presentation palette.

    V30 design rule:
    environmental conditions may change the accent/glow, but the whole
    ClimatePulse hero should remain a stable dark-blue/teal brand surface.
            ...
            items.append(
                {
                    ...
                    "detail": (
                        ...
                        "in the ClimatePulse live globe sample."
                    ),
                }
            )
            ...
            items.append(
                {
                    ...
                    "detail": (
                        ...
                        "ClimatePulse reference-city sample."
                    ),
                }
            )
...
def render_home_page(
    ...
    if detected_location:
        ...
        # to ClimatePulse's active location before downstream data load.
        st.session_state[
...
<div class="cp-v19-wrap">
  ...
  ">
    ...
    globe_col, explore_col = st.columns(
        [
            1.72,
            0.78,
        ],
  ...
  <div class="cp-v19-card-inner">
    <div class="cp-v19-mini-grid">
      ...
      <div class="cp-v19-mini">
        ...
        <div class="cp-v19-mini-note">Relative to ClimatePulse baseline</div>
      </div>
      <div class="cp-v19-mini">
    ...
    with brief_col:
        ...
        if environment and selected:
            ...
            brief = (
                ...
                "location — to generate a data-grounded ClimatePulse brief."
            )
    ...
    <div class="cp-v19-source">{item['source']}</div>
            ...
            if official_alerts:
                ...
                st.caption(
                    ...
                    "ClimatePulse context alerts remain clearly separate."
                )
...
<div class="cp-v19-card">
  <div class="cp-v19-card-inner">
    ...
    st.html(
        '<div class="cp-v19-section">ClimatePulse AI</div>'
    )
...
<div class="cp-v19-card">
  <div class="cp-v19-card-inner">
    ...
    <div class="cp-v19-note">
        ClimatePulse passes the current displayed data into the assistant before it answers.
...
<div style="
    ...
    padding:18px 0 4px;
">
    ClimatePulse · Global Climate Intelligence · live context, not hype
</div>
        """
    )
...
<div class="cp-home-hero">
    <div class="cp-home-kicker">ClimatePulse Dashboard</div>
...
<div class="cp-v19-hero">
    ...
    <div class="cp-v19-copy">
        ClimatePulse explicitly separates historical observations/reanalysis
    ...
    if country_feature is not None:
        ...
        st.caption(
            "City history uses the existing ClimatePulse ERA5 pipeline. "
